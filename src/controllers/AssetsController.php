...
class AssetsController extends Controller
{
    ...
    public function actionEdit(int $elementId): Response
    {
        ...
        Craft::$app->getView()->registerAssetBundle(MuxDashboardAsset::class);
    ...
    public function actionSave(): Response
    {
        ...
        // Mux API–backed fields (MP4 support + static renditions) are applied in
        // Elements::EVENT_BEFORE_SAVE_ELEMENT via Assets::applyMuxAssetMuxApiFieldsFromRequest().
