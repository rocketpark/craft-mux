class MuxEditPanel {
        ...
        _this.editPanel.find('.mux-track-text').each(function(el) {
            ...
            deleteButton.on('click', function(evt) {
                ...
                if (confirm(_confirmMessage)) {
                    ...
                    let body = { id: _this.asset_id, track_id: _track_id };
    ...
    initTrackFormElements() {
        ...
        */
        ...
        let $heading = $('<h2/>').text(Craft.t('mux','Add Mux Track')).appendTo($body);
    ...
    initTrackForm() {
        ...
        this.form.submit(function(evt) {
            ...
            let formData = Object.fromEntries(new FormData(_this.trackSlideout.$container[0]));
            let track = {
            ...
            let body = { id: _this.asset_id, track: track };
            body[Craft.csrfTokenName] = Craft.csrfTokenValue;
