(function ($) {
    ...
    Craft.MuxVolumeFolderSelectorModal = Craft.BaseElementSelectorModal.extend(
        {
            init: function (settings) {
                settings = Object.assign(
                    {},
                    Craft.MuxVolumeFolderSelectorModal.defaults,
                    settings,
                    {
                        showSiteMenu: false,
                    }
                ...
                this.base('rocketpark\\mux\\elements\\MuxAsset', settings);
            },
