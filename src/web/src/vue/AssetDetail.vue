        ...
        <header id="header">
            ...
            <div id="action-buttons" class="flex">
                ...
                <div class="btngroup">
                    ...
                    <button type="button" class="btn submit menubtn" aria-label="More actions" role="combobox" aria-controls="menu.MuxAsset" aria-haspopup="listbox" aria-expanded="false"></button>
                    <div class="menu" data-align="right" role="listbox" id="menu.MuxAsset">
                        <ul role="group">
                            <li role="option" aria-selected="false" id="menu.MuxAsset-aria-option-1">
                                <a class="formsubmit error" tabindex="-1" id="menu.MuxAsset-option-1" @click.prevent="deleteAsset">
                                    Delete MUX Asset
                                </a>
                            </li>
                        </ul>  
        ...
        <div id="content-container">
            ...
            <div id="content" class="content-pane">
                <div id="title-field" class="field" data-attribute="title">
                    ...
                    <div class="input ltr">
                        <input type="text" id="title" class="text fullwidth" name="title" autocomplete="off" dir="ltr" aria-labelledby="title-label" v-model="title">
                    </div>
                </div>
                ...
                <div class="">
                    <div class="mux-video">
                        <mux-player
                            ...
                            :metadata-video-title="asset.title"></mux-player>
                    </div>
                    <hr>
                    <div class="mux-tracks">
                        <h2>Tracks</h2>
                        <div class="mux-tracks-list">
                            <div class="mux-track" v-for="track in asset.tracks" :key="track.id">
                                <asset-track :track="track" :asset-id="asset.asset_id"></asset-track>
                            </div>
                        </div>
...
<script setup>
    ...
    import { deleteAssetById, removeAssetById, state, updateAsset, useAssetById } from "./AssetsStore";
